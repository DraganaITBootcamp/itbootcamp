...
public class YouTubeSearchResultsPage {
	...
	private static List<WebElement> titleOfVideos() {
		return driver.findElements(By.cssSelector("h3.title-and-badge.style-scope.ytd-video-renderer a#video-title")); //domaci
}
	//Actions
	...
	public List<WebElement>getTitleOfVideos(){ //domaci
		return titleOfVideos();
	}
	public String getTitleOfFirstVideo() {
		return getTitleOfVideos().get(0).getText(); //domaci
}
}